...
intractn_on_ladder=ones(number_of_kpoints);
intractn_bt_ladder=exp(j*k*pi/2);
...
%the neareast hopping of the edge
  ...
  Hamiltonian(number_of_basis/2+1,number_of_basis/2+2)=intractn_on_ladder(index_of_k);
